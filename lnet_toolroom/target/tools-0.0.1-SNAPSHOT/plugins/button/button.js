/*
 * Title: Description: Aucthor: 曾宪斌 Aucthor:wangwch Email: zengxianbin@gmail.com
 * Create Date:2009-06-18 Copyright 2009
 */
(function($) {
	$.fn.btn = function() {
		...
		this.init = function() {
			...
			var bntStr = [
					...
					'<INPUT type="', $(this).attr('type'), '"  id="',
					$(this).attr('id'), '"  name="', $(this).attr('name'),
					'" class="z-button z-btn-text ', icon, '"  value="',
					$(this).attr('value'), '"></INPUT>', '</EM></TD>',
