	...
	$.extend({
		progressBar: new function() {
			this.defaults = {
				...
				boxImage	: '../pages/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'../pages/images/progressbg_red.gif',
								30: '../pages/images/progressbg_orange.gif',
								70: '../pages/images/progressbg_green.gif'
